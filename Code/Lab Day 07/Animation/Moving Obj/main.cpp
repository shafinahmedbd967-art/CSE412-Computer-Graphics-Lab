...
void init(void)
{
    ...
    glOrtho(-10, 10, -10, 10, -10, 10); // To specify the coordinate & distances to depth clipping planes
}

int main(int argc, char** argv) // 1. Update main to accept arguments
{
    glutInit(&argc, argv); // 2. Call glutInit FIRST
